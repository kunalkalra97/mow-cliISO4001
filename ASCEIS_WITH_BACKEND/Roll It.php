...
<head>
    ...
    <meta name="author" content="Roll It" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">Roll It</h4>
				</div>
...
<!--
						...
						<li><i class="fa fa-users"></i> <strong class="strong">Maximum Participants: </strong> <br>3</li>
...
<br>Tadap Techi (+91 7708106336)</li>
				...
				<div class="col-md-4 project-info">
					<h5>Event Info</h5>
					<p>Everyone has their own amusing ideas of a roller coaster ride. Well this ICES, we bring to you an opportunity to design this dream into reality as we introduce to you Roll It.
Participants in a team of 3 are supposed to design and create their own roller coaster model using ice cream sticks, straws, cardboard sheets and other stationaries provided on spot. Win amazing prizes worth Rs 10,000 and be a part of this amazing journey.</p>
