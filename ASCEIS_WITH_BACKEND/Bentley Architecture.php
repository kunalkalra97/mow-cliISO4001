...
<head>
    ...
    <meta name="author" content="AECOism Builder Designer" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">AECOism Builder Designer</h4>
				</div>
				<div class="col-md-5 project-photo">
					<img src="images/bentlay%20architecture.jpg" alt="" />
				</div>
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Workshop Info</h5>
					<p>As an architectural engineer, you need to deliver the highest quality work on schedule and under budget. AECOism Builder Designer provides you with endless independence, to discover a lot more layout choices, to help make much better well informed layout judgments, as well as forecast performance and costs. Also construction and Design paperwork are quickly synchronized, removing problems and omissions.</p>
<p>This ICES we bring you Bentley systems the creator of the software as a mentor for the first time for architecture students.
</p>
