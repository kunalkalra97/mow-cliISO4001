...
<head>
    ...
    <meta name="author" content="Geospatial Technology" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">Geospatial Technology</h4>
				</div>
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Workshop Info</h5>
					<p>Geospatial workshop is an umbrella phrase associated with a suite of technologies including remote sensing (RS), Global Positioning System (GPS), Geographic Information System (GIS), information technologies and field sensors that helps in capturing, storing, displaying, processing and disseminating information related to a particular location. Information rich, highly visual and interactive interfaces are being used by organizations in this field to ensure development in Geospatial Science and Technology. Geospatial Technology workshop brings an opportunity to update you with the latest trends and developments in this arena. From integrating field data to GIS platform to processing and creating thematic satellite maps, this workshop would enlighten you in all these fields. </p>
