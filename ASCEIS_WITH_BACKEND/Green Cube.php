...
<head>
    ...
    <meta name="author" content="Green Cube" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">Green Cube</h4>
				</div>
				...
				<div class="col-md-3 project-details">
					...
					<ul class="details-list">
						...
						<br></strong> Rs. 400<span style="color: red">*</span></li>
...
<!--
						...
						<li><i class="fa fa-users"></i> <strong class="strong">Maximum Participants: </strong> <br>4</li>
...
<br>Tadap Techi (+91 7708106336)</li>
				...
				<div class="col-md-4 project-info">
					<h5>Event Info</h5>
					<p>Green being the new buzzword this ICES we bring to you Green Cube. Caste 3 concrete cube without using Ordinary Portland Cement (OPC) of dimensions 150x150 150 mm^3 and get it tested for density. The mass will be measured using a sensitive weighing balance. The volume will be calculated by measuring the sides of the cube manually using Vernier calipers then from the obtained data, density will be calculated. Compressive strength will be measured using compression testing machine (CTM).The rate of loading will be 140 kg/cm2 per minute. Technical mix design report which includes material specifications, casting and curing procedure has to be submitted along with the cubes </p>
