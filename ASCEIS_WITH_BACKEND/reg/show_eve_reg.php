...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="well">
      <div class="col-md-13" style="float:none; margin:0px auto;">
        <?php
        if($id!="20" && $id!="30")
        {
          $sql="SELECT * from ".$e_ty."_reg as e_r inner join register as rg on e_r.u_id=rg.id where ".$e_ty."_id=".$id." ";
	...
	$sql="SELECT * from ".$e_ty."_reg as e_r inner join register as rg on e_r.u_id=rg.id  ";
