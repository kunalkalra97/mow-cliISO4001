  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="col-md-7" style="float:none; margin:0px auto;">
        ...
        <form method="POST" action="show_eve_reg_dd.php">
        ...
        <tr>
          <th colspan="2" style="text-align:center">Events</th>
            ...
            while ($i<4) {
              ...
              $sql="SELECT * from eve_reg where eve_id='".$i++."' and (dd='t' || ol='t')";
          ...
          <td>".$c."</td>
            ...
            while ($i<15) {
              ...
              $sql="SELECT * from wor_reg where wor_id='".$i++."' and (dd='t' || ol='t')";
              $res=mysqli_query($con,$sql);
              $c=mysqli_num_rows($res);
               echo " <tr>
              <td>".$nn."</td>
          <td>".$c."</td>
            ...
            $i=1;
              ...
              $sql="SELECT * from uce_reg where dd='t' ";
              $res=mysqli_query($con,$sql);
              $c=mysqli_num_rows($res);
               echo " <tr>
              <td>UCES</td>
          <td>".$c."</td>
            ...
            $i=1;
              ...
              $sql="SELECT * from con_reg where dd='t' OR ol='t' ";
              $res=mysqli_query($con,$sql);
              $c=mysqli_num_rows($res);
               echo " <tr>
              <td>Conference</td>
