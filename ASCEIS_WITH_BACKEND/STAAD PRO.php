...
<head>
    ...
    <meta name="author" content="STAAD.PRO" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">STAAD.PRO</h4>
				</div>
				<div class="col-md-5 project-photo">
					<img src="images/staad.jpg" alt="" />
				</div>
            ...
            <li><i class="fa fa-user"></i> <strong class="strong">Conducted By: </strong> <br>Bentley</li>
<!--
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Workshop Info</h5>
					<p>STAAD.PRO V8i is a Structural Analysis and Design Software powered by Bentley systems. With an array of advanced analysis capabilities including linear static , response spectra , time history, cable, imperfection, and non-linear analysis , STAAD.PRO V8i provides a callable solution that will meet the demands of the project every time. The software reduces the man-hours required to properly load the structure by automating the forces caused by wind, earthquakes, snow or vehicles to ensure on time and on budget completion of your steel, concrete, timber, aluminum, and cold-formed steel projects regardless of the complexity. The creators of the software, Bentley systems will be conducting the workshop that makes the learning experience like never before.</p>
