...
<head>
    ...
    <meta name="author" content="CADathon" >
    <meta charset="utf-8">
...
<div class="section" style="padding-top:60px; padding-bottom:0px; border-top:1px solid #eee; border-bottom:1px solid #eee; background: url(images/events .jpg);">
                <div class="container">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">CADathon</h4>
				</div>
				<div class="col-md-5 project-photo">
					<img src="images/Geospatial%20Technology.jpg" alt="" />
				</div>
				<div class="col-md-3 project-details">
					...
					<ul class="details-list">
						...
						<br></strong> Rs. 300<span style="color: red">*</span></li>
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Event Info</h5>
					<p>An event that focuses on evaluating the ability of the participants to use Computer Aided Design (CAD) tools. The participants are required to create something that is artistic, aesthetically pleasing and productive in relation with the topic and guidelines provided. The event tests the promptness in understanding and solving the issues raised in reality at the designing arena. Participants would be provided with scenarios and conditions which need to be solved on pre-determined version of CAD software. It's a 10 hour stretch event that would run throughout the night. Get a chance to win Rs 10,000 and many more exciting prizes. Participants are requested to bring their laptops. </p>
					<span style="color: red">*</span> (Exclusive of Taxes) Inclusive of unlimited refreshments.
				</div>
			</div>
		</div>
	</div>
