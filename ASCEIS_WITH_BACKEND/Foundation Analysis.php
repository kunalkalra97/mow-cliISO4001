...
<head>
    ...
    <meta name="author" content="Foundation Analysis" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">Advance Foundation Analysis</h4>
				</div>
				<div class="col-md-5 project-photo">
					<img src="images/Foundation%20Analysis.jpg" alt="" />
				</div>
				<div class="col-md-3 project-details">
					...
					<ul class="details-list">
						...
						<br></strong> Rs. 1000<span style="color: red">*</span></li>
            <li><i class="fa fa-clock-o"></i> <strong class="strong">Duration: </strong> <br>2 Day</li>
            <li><i class="fa fa-user"></i> <strong class="strong">Conducted By: </strong> <br>Civil Simplified</li>
<!--
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Workshop Info</h5>
					<p>You can’t build a great building on a weak foundation. This is because of the challenge involved in analyzing a structure even before the construction starts. </p>
<p>So this ICES, we are giving you the opportunity to attend a workshop on foundation analysis conducted by civil simplified. The workshop deals with analysis and design of different footing and theory of structure via real world case studies.
</p>
