...
<head>
    ...
    <meta name="author" content="Advances in Transportation Engineering" >
    <meta charset="utf-8">
		...
		<div class="portfolio-project">
			<div class="row">
				<div class="col-md-10 col-md-offset-1 center section-title">
					<h4 style="color:#EA4C3C;">Advances in Transportation Engineering</h4>
				</div>
				<div class="col-md-5 project-photo">
					<img src="images/Advances%20in%20Transportation%20Engineering.jpg" alt="" />
				</div>
...
-->
				...
				<div class="col-md-4 project-info">
					<h5>Workshop Info</h5>
					<p>The field of urban transportation in India has got significant changes in the past few decades due to the advancements in planning, operation and management of transportation facilities. So it is necessary to understand the basics of travel demand modeling approaches as well as advanced approaches like activity based travel demand modeling and Intelligent Transportation Systems (ITS). Hence, detailed understanding of various components and applications of ITS become a key necessity in countries like India. Keeping these objectives in mind, the present workshop will provide an in-depth understanding of recent trends in the area of transport planning, traffic engineering and pavement design by professional expert.</p>
